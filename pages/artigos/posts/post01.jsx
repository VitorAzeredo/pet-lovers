                    ...
                    <div className="row gx-5">
                        <div className="col-lg-3 p-0">
                            <div className="d-flex align-items-center mt-lg-5 mb-4">
                                <img className="img-fluid rounded-circle" src="/assets/artigos_destaque/ana_leticia.png" alt="..." />
                                <div className="ms-3">
                        ...
                        <div className="col-lg-9 p-0">
                            <article>
                                <header className="mb-4">
                                    <h1 className="fw-bolder mb-1">O que perguntar ao veterinário na 1ª consulta do seu pet.</h1>
                                        <div className="text-muted fst-italic mb-2">12 Novembro, 2021</div>
                                ...
                                <figure className="mb-4"><img className="img-fluid rounded mb-5 mb-lg-0" src="/assets/artigos_destaque/veterinario.webp" alt="..." /></figure>
                                ...
                                <section className="mb-5">
                                    ...
                                    <p className="fs-5 mb-4">Fornecer essas informações iniciais sobre o filhote ajudarão o médico-veterinário a entender melhor seus primeiros dias de vida e ter conhecimento de alguns fatores que podem interferir na boa saúde do filhote.</p>
                                    
                                    <h2 className="fw-bolder mb-4 mt-5">1 &middot; VERMIFUGAÇÃO E VACINAÇÃO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">2 &middot; EXAME DE SANGUE</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">3 &middot; CONTROLE DE ECTOPARASITAS</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">4 &middot; ALIMENTAÇÃO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">5 &middot; COMPORTAMENTO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">6 &middot; PESO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">7 &middot; CASTRAÇÃO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">8 &middot;  MICROCHIPAGEM</h2>
                                    <p className="fs-5 mb-4">Nessa consulta inicial também pode ser realizada a microchipagem dos filhotes, que funciona como o RG do animalzinho, além de ser um método bastante eficiente para localizar esse pet caso ele se perca ou fuja.</p>

                                    <h2 className="fw-bolder mb-4 mt-5">9 &middot;  ROTINA DE BANHOS</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">10 &middot;  RETORNO AO VETERINÁRIO</h2>
