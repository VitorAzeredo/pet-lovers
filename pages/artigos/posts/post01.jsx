                        ...
                        <div className="col-lg-9 p-0">
                            <article>
                                ...
                                <section className="mb-5">
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">1. VERMIFUGAÇÃO E VACINAÇÃO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">2. EXAME DE SANGUE</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">3. CONTROLE DE ECTOPARASITAS</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">4. ALIMENTAÇÃO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">5. COMPORTAMENTO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">6. PESO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">7. CASTRAÇÃO</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">8. MICROCHIPAGEM</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">9. ROTINA DE BANHOS</h2>
                                    ...
                                    <h2 className="fw-bolder mb-4 mt-5">10. RETORNO AO VETERINÁRIO</h2>
