                        ...
                        <div className="col-lg-9 p-0">
                            <article>
                                <header className="mb-4">
                                    <h1 className="fw-bolder mb-1">Cães de trabalho: conheça as 5 principais profissões desses animais.</h1>
                                    <div className="text-muted fst-italic mb-2">17 de Maio, 2022</div>
                                    <a classNameName="badge bg-dark text-decoration-none link-light me-1">Médicina</a>
                                    <a className="badge bg-dark text-decoration-none link-light">Veterinária</a>
                                </header>
                                <figure className="mb-4"><img className="img-fluid rounded mb-5 mb-lg-0" src="/assets/artigos_destaque/trabalho/resgate.jpg" alt="..." /></figure>
                                <section className="mb-5">
                                    ...
                                    <h3 className="fw-bolder mb-4">A história dos cães de trabalho</h3>
                                    ...
                                    <p className="fs-5 mb-4">Até na zona rural os cães possuem grande importância, sendo funcionários efetivos. Atuando no manejo e deslocamento dos animais com pequenos gestos e sons, o cão consegue realizar com muita agilidade tarefas que levariam horas para um ser humano.</p>

                                    <h3 className="fw-bolder mb-4">Como um cão aprende a desempenhar essas funções?</h3>
                                    ...
                                    <h3 className="fw-bolder mb-4">Para contextualizar, precisamos entender qual é o papel de cada cão na sua atividade. Por exemplo:</h3>
